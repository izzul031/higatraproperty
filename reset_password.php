    ...
    <div class="container py-5 h-100">
      <div class="row d-flex align-items-center justify-content-center h-100">
        ...
        <div class="col-md-7 col-lg-5 col-xl-5">
          <form class="form_login"  cmethod="POST" action="process_reset_password.php?token=<?php echo $token; ?>">
            ...
            <div class="form-outline mb-4 input-group">
              <input type="newPassword" id="new_password" class="form-control form-control-lg py-3" name="new_password" autocomplete="off" placeholder="New Password" />
            </div>

...
<title>Detail Layanan Branding dan Pemasaran</title>
    ...
    <section class="us_section2 layout_padding">
        <div class="container tabel_harga">
            <div class="heading_container navy2 mb-4">
                <h2>Branding dan Pemasaran</h2>
            </div>
            <div class="service-details mb-5">
                <div class="row justify-content-center">
                    <p>
                        Layanan branding dan pemasaran properti untuk membantu Anda menjual atau memasarkan rumah dengan strategi yang efektif.
                    </p>
                </div>
            </div>
            <div class="heading_container navy2 mb-5">
                <h2>TABEL HARGA JASA Branding dan Pemasaran</h2>
            </div>

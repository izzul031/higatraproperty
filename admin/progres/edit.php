...
if (isset($_POST['submit'])) {
    ...
    if ($gambar) {
        ...
        $queryUpdate = "UPDATE progres SET id_klien = '$id_klien', gambar = '$gambar', deskripsi = '$deskripsi' WHERE id = $id";
    } else {
        // Jika tidak ada gambar baru yang diupload
        $queryUpdate = "UPDATE progres SET id_klien = '$id_klien', deskripsi = '$deskripsi' WHERE id = $id";
    }

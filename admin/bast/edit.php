...
$id = $_GET['id'];
$query = "SELECT * FROM bast WHERE id = $id";
...
if (isset($_POST['submit'])) {
    ...
    if ($gambar) {
        $target = "../../images/bast/" . basename($gambar);
        move_uploaded_file($_FILES['gambar']['tmp_name'], $target);
        $queryUpdate = "UPDATE bast SET id_klien = '$id_klien', gambar = '$gambar', deskripsi = '$deskripsi' WHERE id = $id";
    } else {
        // Jika tidak ada gambar baru yang diupload
        $queryUpdate = "UPDATE bast SET id_klien = '$id_klien', deskripsi = '$deskripsi' WHERE id = $id";
    }

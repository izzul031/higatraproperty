...
<title>Detail Layanan Perawatan Gedung</title>
    ...
    <section class="us_section2 layout_padding">
        <div class="container tabel_harga">
            <div class="heading_container navy2 mb-4">
                <h2>Perawatan Gedung</h2>
            </div>
            <div class="service-details mb-5">
                <div class="row justify-content-center">
                    <p>
                        Layanan perawatan gedung meliputi perawatan struktural, teknis, dan kebersihan untuk menjaga bangunan dalam kondisi optimal.
                    </p>
                </div>
            </div>
            <div class="heading_container navy2 mb-5">
                <h2>TABEL HARGA JASA Perawatan Gedung</h2>
            </div>

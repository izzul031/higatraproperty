...
<title>Detail Layanan Notaris dan PPAT</title>
    ...
    <section class="us_section2 layout_padding">
        <div class="container tabel_harga">
            <div class="heading_container navy2 mb-4">
                <h2>Jasa Notaris dan PPAT</h2>
            </div>
            <div class="service-details mb-5">
                <div class="row justify-content-center">
                    <p>
                        Layanan pengurusan dokumen transaksi properti, termasuk jual beli, pajak, dan balik nama sertifikat, dengan cepat dan aman.
                    </p>
                </div>
            </div>
            <div class="heading_container navy2 mb-5">
                <h2>TABEL HARGA JASA Jasa Notaris dan PPAT</h2>
            </div>

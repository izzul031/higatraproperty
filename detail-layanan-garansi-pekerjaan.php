...
<title>Detail Layanan Garansi Pekerjaan</title>
    ...
    <section class="us_section2 layout_padding">
        <div class="container tabel_harga">
            <div class="heading_container navy2 mb-4">
                <h2>Garansi Pekerjaan</h2>
            </div>
            <div class="service-details mb-5">
                <div class="row justify-content-center">
                    <p>
                        Semua pekerjaan kami dilindungi garansi sesuai perjanjian, sebagai komitmen terhadap kualitas dan kepuasan klien.
                    </p>
                </div>
            </div>
            <div class="heading_container navy2 mb-5">
                <h2>TABEL HARGA JASA Garansi Pekerjaan</h2>
            </div>
